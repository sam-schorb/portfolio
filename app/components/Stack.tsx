...
const stackUrls: { [key: string]: string } = {
  ...
  HuggingFace: 'https://huggingface.co/iimaginary',
...
export default function Stack() {
  ...
  return (
    <div>
      ...
      <p className="text-xl mt-4 mb-12 text-mediumGray">
        The complete toolkit that powers my work.
      </p>
